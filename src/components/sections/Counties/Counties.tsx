  ...
  useEffect(() => {
    ...
    const loadCounties = async () => {
      ...
      try {
        ...
        // Hardcoded county data - same structure as cities
        const hardcodedCounties: CountyListing[] = [
          {
            slug: 'orange-county',
            name: 'Orange County',
            state: 'CA',
            shortDescription: 'A coastal region known for its stunning beaches, upscale neighborhoods, and family-friendly communities, with world-class dining and shopping.',
            heroImage: 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=1920&q=80',
            cityCount: '34',
            tags: ['Coastal Living', 'Family-friendly']
          },
          {
            slug: 'los-angeles-county',
            name: 'Los Angeles County',
            state: 'CA',
            shortDescription: 'A diverse cultural hub offering everything from entertainment and arts to bustling business districts and scenic coastal escapes.',
          ...
          },
          {
            ...
            state: 'CA',
            shortDescription: 'A laid-back paradise with beautiful beaches, a thriving tech and biotech scene, and year-round perfect weather.',
            heroImage: 'https://upload.wikimedia.org/wikipedia/commons/8/81/Skyline_of_San_Diego.jpg',
            cityCount: '18',
            tags: ['Beaches', 'Outdoor Living']
          }
        ]
      ...
      <section className="cities-section-beautiful" id="cities">
        <div className="cities-container-beautiful">
          ...
          <div className="cities-grid-beautiful">
            <div className="loading-placeholder">Loading counties...</div>
          </div>
        </div>
      </section>
    )
    ...
    return (
      <section className="cities-section-beautiful" id="cities">
        <div className="cities-container-beautiful">
          ...
          <div className="cities-grid-beautiful">
            <div className="no-cities-placeholder">No counties available at the moment.</div>
          </div>
        </div>
      </section>
    )
              ...
              <div className="city-card-inner-beautiful">
                <div className="city-image-beautiful" style={{ backgroundImage: `url('${county.heroImage}')` }}>
                  ...
                  <div className="city-badges-beautiful">
                    ...
                    <span className="city-price-badge-beautiful">{county.cityCount} cities</span>
                  </div>
                </div>
